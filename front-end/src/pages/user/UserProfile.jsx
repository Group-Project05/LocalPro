                ...
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8">
                    <div className="relative group">
                        <div className="w-28 h-28 rounded-[2.5rem] overflow-hidden shadow-2xl ring-4 ring-white">
                            <img src={`https://ui-avatars.com/api/?name=${user.name || "User"}`} className="w-full h-full object-cover" />
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl">
                                ...
                                <span className="text-sm font-bold text-slate-700">{user.address?.street},
